...
import { CnpmcoreRegistry } from 'app/common/adapter/registry/CnpmcoreRegistry';
import { PackageSyncerService } from 'app/core/service/PackageSyncerService';
import { TestUtil } from 'test/TestUtil';


describe('test/common/adapter/registry/CnpmcoreRegistry.test.ts', () => {
  let ctx: Context;
  ...
  describe('handleChanges()', () => {
    it('should sync all packages', async () => {
      ...
      assert(syncCount === data.results.length);
