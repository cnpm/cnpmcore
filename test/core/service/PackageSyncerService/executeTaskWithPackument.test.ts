...
describe('test/core/service/PackageSyncerService/executeTaskWithPackument.test.ts', () => {
  ...
  describe('executeTask()', () => {
    it.only('should auto sync _npmUser property when it different', async () => {
      ...
      assert.match(log, /🟢 Synced version 0.0.0 success, different meta: {"deprecated":"only test for cnpmcore","_npmUser":{"name":"fengmk2-changed","email":"fengmk2@gmail.com"}}/);
      assert.ok(res.data);
