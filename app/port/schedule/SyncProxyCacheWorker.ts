  ...
  async subscribe() {
    ...
    try {
      ...
      while (task) {
        ...
        this.logger.info(
          '[SyncProxyCacheWorker:subscribe:executeTask:start][%s] taskId: %s, targetName: %s, attempts: %s, params: %j, updatedAt: %s, delay %sms',
          executingCount,
          task.taskId,
          task.targetName,
          task.attempts,
        ...
        this.logger.info(
          '[SyncProxyCacheWorker:subscribe:executeTask:success][%s] taskId: %s, targetName: %s, use %sms',
          executingCount,
          task.taskId,
          task.targetName,
          use
