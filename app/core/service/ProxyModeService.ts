...
export class ProxyModeService extends AbstractService {
  ...
  async getPackageVersionTarAndTempFilePath(fullname: string, url: string): Promise<{ tgzBuffer:Buffer| null, tempFilePath: string}> {
    ...
    return { tgzBuffer, tempFilePath: tmpfile };
  }
